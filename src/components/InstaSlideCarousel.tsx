      ...
      <div className="w-full max-w-md rounded-2xl shadow-2xl overflow-hidden border border-zinc-800">
        ...
        <div className="relative aspect-square bg-black overflow-hidden">
          ...
          {currentIndex > 0 && (
            <button
              onClick={prevSlide}
              className="absolute left-3 top-1/2 -translate-y-1/2 w-8 h-8 rounded-full bg-zinc-800/80 backdrop-blur-sm flex items-center justify-center shadow-lg hover:bg-zinc-700 transition-all hover:scale-110 z-10"
            >
          ...
          {currentIndex < images.length - 1 && (
            <button
              onClick={nextSlide}
              className="absolute right-3 top-1/2 -translate-y-1/2 w-8 h-8 rounded-full bg-zinc-800/80 backdrop-blur-sm flex items-center justify-center shadow-lg hover:bg-zinc-700 transition-all hover:scale-110 z-10"
            >
...
export default InstagramSlideCarousel;
